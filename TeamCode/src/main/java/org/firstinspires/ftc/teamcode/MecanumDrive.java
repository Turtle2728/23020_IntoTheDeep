...
public final class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.002236369294;
        public double trackWidthTicks = 3309.23978740687;

        // feedforward parameters (in tick units)
        public double kS = 0.9102551266550418;
        public double kV = 0.0006035297148368339;
